...
<h1 id="h1_sta_vente">Détails vente selon un groupe</h1><br/>
<div class="fms">
<form method="POST" action="">
<label for="groupe">Nom du groupe</label><br/>
<div id="List_groupe"></div>
<input required type="text" name="nom_g" id="nom_g"/><br/><br/>
<input type="submit" class="submit" id="sub_nom_g" value="Consulter">
</form><br/><br/>
<script>  
...
{  
    ...
    if($bd)
	{
		...
		if($r1)
		{
			...
			echo "<span class='avert'>Le $grpe n'a effectué aucune vente</span><br/>";
	}
	else
