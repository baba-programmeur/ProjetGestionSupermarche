	...
	if($bd)
	{
		...
		if($r)
		{
			...
			{ 
				...
				{
					if($date_deb<=$date_def)
						echo "La boutique a vendu ".$nb_prod_v_p." produits dans la période du <span class='succ'>".$date_deb." au ".$date_def."</span> dont:<br/><br/>";
					else
						echo "La boutique a vendu ".$nb_prod_v_p." produits dans la période du <span class='succ'>".$date_def." au ".$date_deb."</span> dont:<br/><br/>";
					...
					echo "Toutes les ventes de la boutique confondues dans cette periode dont une somme totale de <span class='succ'>".$chiffre_daffaire." Fcfa</span>";
				}
				else
